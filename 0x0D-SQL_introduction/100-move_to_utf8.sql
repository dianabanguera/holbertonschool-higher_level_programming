...
--      Table first_table
ALTER TABLE hbtn_0c_0.first_table CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci;
--      Field name in first_table
ALTER TABLE hbtn_0c_0.first_table MODIFY `name` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci;
